    ...
    <div class="cart-product clearfix">
        <table>
            ...
            <tr v-for="(item,index) in productList" :key="index">
                ...
                <td class="td-product"><img :src="'static/img/index/'+item.pro_img" width="98" height="98">
...
.page-shopping-cart .check-span.check-true {
  background: #333 no-repeat 0 -22px;
}
...
.page-shopping-cart .cart-product table .product-num .num-reduce span {
  background: #333 no-repeat -40px -22px;
  display: block;
  width: 6px;
  height: 2px;
...
.page-shopping-cart .cart-product table .product-num .num-add span {
  background: #333 no-repeat -60px -22px;
  display: block;
  width: 8px;
  height: 8px;
...
.page-shopping-cart .cart-product-info .delect-product span {
  ...
  width: 13px;
  height: 15px;
  background: #333 no-repeat -60px 0;
}
...
.page-shopping-cart .cart-product-info .keep-shopping span {
  ...
  width: 15px;
  height: 15px;
  background: #333 no-repeat -40px 0;
}
...
.page-shopping-cart .cart-worder .choose-worder span {
  ...
  width: 22px;
  height: 22px;
  background: #333 no-repeat -92px 0;
}
...
.choose-worker-box .box-title a {
  ...
  width: 10px;
  height: 10px;
  background: #333 no-repeat -80px 0;
}

.choose-worker-box .box-title a:hover {
  background: #333 no-repeat -80px -22px;
}
